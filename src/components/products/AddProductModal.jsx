...
export default function AddProductModal({ onClose, onSaved }) {
  ...
  const [form, setForm] = useState({
    prodCode: '', description: '', unit: 'ea', unitPrice: '',
  ...
  const handleSubmit = async e => {
    ...
    setError('')
    setLoading(true)
    const err = await addProduct(form, currentUser.username)
    if (err) { setError(err.message); setLoading(false); return }
    if (form.unitPrice && form.effDate) {
      await addPriceEntry(form.prodCode, form.effDate, parseFloat(form.unitPrice), currentUser.username)
    }
    onSaved(); onClose()
    setLoading(false)
  }
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <div>
            ...
            <input name="prodCode" required maxLength={6} placeholder="e.g. AK0010"
          ...
          <div>
            ...
            <input name="description" required maxLength={30} placeholder="Max 30 characters"
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input name="unitPrice" type="number" step="0.01" min="0.01" placeholder="0.00"
              ...
              <div className="flex-1">
                ...
                <input name="effDate" type="date" value={form.effDate} onChange={handleChange}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>
          </div>
