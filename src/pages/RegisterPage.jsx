      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 w-full max-w-sm p-8 text-center">
          ...
          <p className="text-xs text-gray-400">
            After confirming, an administrator will activate your account before you can log in.
          </p>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 w-full max-w-sm p-8">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-3">
          <div className="flex gap-2">
            <input
              ...
              className="border border-gray-300 rounded px-3 py-2 text-sm w-1/2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <input
        ...
        <button
          ...
          className="w-full border border-gray-300 rounded py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-2"
        >
